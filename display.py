...
def logs():
    ...
    # Debug print statements to verify conditions
    print(f"pH: {ph_value}, Temp: {temperature}, Flow: {flow_value}, Turbidity: {turbidity}")
